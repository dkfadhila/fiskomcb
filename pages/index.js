  ...
  return (
    <div className="relative min-h-screen p-8 text-white">
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        {/* Judul */}
        <h1 className="text-5xl font-bold mb-8 bg-clip-text text-transparent text-center bg-gradient-to-r from-pink-400 via-purple-400 to-indigo-400">
          Nilai Mahasiswa Komputasi Fisika
        </h1>

        {/* Input NIM */}
        <div className="flex gap-4 mb-8">
          <input type="text" placeholder="Masukkan NIM" value={nim}
        ...
        {stu && (
          <>
            ...
            <div className="mb-6 p-4 bg-yellow-800 rounded-lg border-l-4 border-yellow-400">
              <strong>Catatan Penilaian:</strong> Semua nilai Praktikum maksimum 95; Nilai Anda 0 dikarenakan anda ketahuan melakukan plagiasi Tugas dengan cara memfoto/Screenshot pekerjaan mahasiswa lain (tidak menggunakan workspace sendiri) dan tidak mengumpulkan atau tidak ditemukan file yang mendukung.
            </div>

            {/* Profile Postcard */}
            <div className="p-6 bg-gradient-to-r from-purple-600 to-purple-800 rounded-3xl shadow-xl text-center mb-8">
              <img src={gradeImages[stu.grade]||gradeImages.E} alt={`Grade ${stu.grade}`}
